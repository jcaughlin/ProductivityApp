...
CREATE TABLE `user_roles` (
  ...
  `role_name` enum('USER','PENDING','ADMIN','SUSPENDED') DEFAULT 'PENDING',
...
INSERT INTO `user_roles` VALUES ('Debbie','USER',21),('deedee','PENDING',22),('jerry','USER',23),('joe','ADMIN',24),('joeyramonr','USER',25),('johnny','USER',26),('littlesteven','SUSPENDED',27),('patti','USER',28),('richie','USER',29),('soultrain','USER',30),('steve','USER',31);
